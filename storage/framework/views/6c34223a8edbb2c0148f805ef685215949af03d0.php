	...
	<div class="section section-basic">
	   	<div class="container">
	   		<div class="col-lg-6 col-sm-6 col-md-6">
	   			<?php echo $__env->make('includeview.gallary', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	   		</div>
	   		<div class="col-lg-6 col-sm-6 col-md-6">
	   			<h1>Package Name</h1>
	   			<h4>Rate : 
										...
										<div class="tab-pane active" id="studio">
							        		<div class="media">
												<div class="media-left media-middle">
												    <a href="#">
												      <img class="media-object" src="<?php echo e(asset('/picture/profile/profile.png')); ?>" alt="...">
												    </a>
												</div>
		...
		<div class="container">
			...
			<div class="owl-carousel owl-theme">
			    <div class="item">
			    	<a href="">
			    		<div class="column productbox">
						    <img src="<?php echo e(asset('/picture/gift/g2.jpg')); ?>" class="img-responsive">
			    ...
			    <div class="item">
			    	<a href="">
			    		<div class="column productbox">
						    <img src="<?php echo e(asset('/picture/gift/g3.jpg')); ?>" class="img-responsive">
						    <div class="producttitle">
						    	<h4>CHOCOLATE LOVE</h4>
						    	<p >This is the package make perfectly for valentine day indoor and out door</p>
						    </div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<?php echo $__env->make('includeview.formwizard', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			</div>
		</div>
	</div>
</div>
