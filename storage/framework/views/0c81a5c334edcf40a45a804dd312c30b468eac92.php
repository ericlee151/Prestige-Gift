...
<body>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
	    <div class="container footer">
	      	...
	      	<div class="brand-centered">
	      		<div class="logo">
		            <img src="<?php echo e(asset('picture/logo/logo.png')); ?>"  rel="tooltip" title="<b>Prestige Gift</b> is the best wishes for happiness <b> --Prestige </b>" data-placement="bottom" data-html="true">
		        </div>
	      	</div>
	...
	<div class="section section-black">
		<div class="container">
			<div align="center">
				<img src="<?php echo e(asset('/picture/logo/logo.png')); ?>" alt="">
			</div>
			<div class="row">
